    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            if (!insurancePurchased)
                ...
                try {
                    logger.info("Insurance added: " + getInsurancePlans().get(insuranceType).getName());
                } catch (UnloadedDataException e) {
                    logger.error(e.getMessage(), e);
                    throw new RuntimeException(e);
                }
            ...
            Shipment shipment;
            try {
                shipment = new Shipment(sender, recipient, shippingPackage, getInsurancePlans().get(insuranceType), priority);
            } catch (UnloadedDataException e) {
